 ...
 * getLastStockRecord method.
 * 
 * @author Spencer Dent
 * @version 2021-05-02
 */
public class StockManagerWhenGetLastStockRecord {

	/**
	 * Tests getLastStockRecord on a StockManager with a single StockRecord. Should
	 * return that StockRecord.
	 */
	@Test
	public void testGetLastStockRecordOnStockManagerWithOnlyOneStockRecordShouldReturnThatRecord() {
		...
		assertEquals(expectedStockRecord, testStockManager.getLastStockRecord());
	}
	 ...
	 */
	@Test
	public void testGetLastStockRecordOnStockManagerWithMultipleStockRecordsShouldReturnLastInsertedRecord() {
